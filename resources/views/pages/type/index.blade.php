            ...
            <div class="card-body">
                <div class="row mb-3">
                    ...
                    <div class="col-md-8 d-flex justify-content-end">
                            <button data-url="{{ route('tipe.create') }}" class="btn btn-primary btn-sm" id="btn-create">
                                <i class="fas fa-plus"></i> Tambah
                            </button>
                    </div>
                </div>
                <div class="table-responsive">
                    <table id="tableType" class="table table-striped table-bordered no-wrap" style="width: 100%">
                        <thead>
                            <tr>
                                {{-- <th>No</th> --}}
                                <th>Nama</th>
